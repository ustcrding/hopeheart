package com.boc.hopeheatapp.widget.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    public BottomBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, DensityUtils.dip2Px(mContext, mMarginTop));
        ...
        mItemPadding = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemPaddingss, 0);
