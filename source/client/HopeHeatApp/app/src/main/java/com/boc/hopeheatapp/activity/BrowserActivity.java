 ...
 * @date 2015-11-07.
 */
public class BrowserActivity extends TitleColorActivity implements OnClickListener {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (overrideInNewActivity) {
                    ActivityJumper.startBrowserActivityWithTitle(BrowserActivity.this, url, null, overrideInNewActivity);
                } else {
                    view.loadUrl(url);
                }
                return true;
