package com.boc.hopeheatapp.util.json;
...
public class JsonUtils {
    ...
    public static String toJson(Object target, Type targetType,
        ...
        try {
            ...
            Logger.d(TAG, "目标对象 " + target.getClass().getName()
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,
        ...
        try {
            ...
            Logger.d(TAG, json + " 无法转换为 " + token.getRawType().getName()
                    + " 对象!", ex);
            return null;
        }
    }
    ...
    public static boolean isEmpty(String inStr) {
        return StringUtil.isEmpty(inStr);
    }

    private static Gson gsonUtil = new GsonBuilder().setDateFormat(
            "yyyy-MM-dd HH:mm:ss").create();

    @SuppressWarnings("unchecked")
    public static Object fromJson2(String jsonString, Class pojoCalss) {
        return gsonUtil.fromJson(jsonString, pojoCalss);
    }

    public static String toJson2(Object javaObj) {
        return gsonUtil.toJson(javaObj);
    }
}
