package com.boc.hopeheatapp.util.string;
...
public class StringUtil {
    ...
    /**
     * 将String转化为Integer，转化失败就返回默认值
     * @param intStr
     * @param defaut
     * @return
     */
    public static Integer getIntegerFromStr(String intStr, int defaut) {
    	int returnInt = 0;
    	try {
    ...
    /**
     * 将String转化为Float，转化失败就返回默认值
     * @param floatStr
     * @param defaut
     * @return
     */
    public static float getFloatFromStr(String floatStr, float defaut) {
    	float returnFloat = 0;
    	try {
    		returnFloat = Float.parseFloat(floatStr);
    	}catch(Exception e) {
    		returnFloat = defaut;
    	}
    	return returnFloat;
