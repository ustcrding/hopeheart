 ...
 * @date 2018/2/8.
 */
public class ScheduleSystemActivity extends TitleColorActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_system);
    ...
    private void initTitle() {
        ...
        tvTitle.setText(R.string.title_schedule_system);
