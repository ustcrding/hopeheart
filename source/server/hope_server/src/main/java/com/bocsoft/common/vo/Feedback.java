...
public class Feedback {
    ...
    public static final String MSG_CHECK_SUCCESS = "数据审核完成.";
    public static final String MSG_CHECK__ERROR = "数据审核回退.";
...
//	private static Feedback saveErrorFeedback = new Feedback(false, MSG_SAVE_ERROR);
	private static Feedback updateSuccessFeedback = new Feedback(true,
			MSG_UPDATE_SUCCESS);
    private static Feedback checkSuccessFeedback = new Feedback(true,
            MSG_CHECK_SUCCESS);
