...
from 文本摘要.textsum import data_utils
from 文本摘要.textsum import seq2seq_model_attn

file_path = os.path.dirname(os.path.abspath(__file__))
data_path = os.path.join(file_path, "../my_data/")
train_dir = os.path.join(file_path, "../my_ckpt/")
